...
JOBS=(
  ...
  # Apr 21/22 new runs
  "eval-nopca-bs4096-mpfalse-0421|Embedding_hlt_linformer_supcon_ce_no_pca_bs4096_mpfalse_encoder_20260421_220300.pth|abcd_outputs_supcon_ce_no_pca_bs4096_mpfalse_0421_raw_md|supcon_ce_no_pca_bs4096_mpfalse_0421_raw_md"
  "eval-nopca-512model-lowerdisco-0421|Embedding_hlt_linformer_supcon_ce_no_pca_512model_lower_disco_encoder_20260421_211139.pth|abcd_outputs_supcon_ce_no_pca_512model_lower_disco_0421_raw_md|supcon_ce_no_pca_512model_lower_disco_0421_raw_md"
  "eval-nopca-bs4096-mpfalse-0422|Embedding_hlt_linformer_supcon_ce_no_pca_bs4096_mpfalse_encoder_20260422_041128.pth|abcd_outputs_supcon_ce_no_pca_bs4096_mpfalse_0422_raw_md|supcon_ce_no_pca_bs4096_mpfalse_0422_raw_md"
  "eval-nopca-supcon-mar25-0422a|embedding_hlt_linformer_supcon_mar25_encoder_20260422_032258.pth|abcd_outputs_supcon_mar25_0422a_raw_md|supcon_mar25_0422a_raw_md"
  "eval-nopca-supcon-mar25-0422b|embedding_hlt_linformer_supcon_mar25_encoder_20260422_083430.pth|abcd_outputs_supcon_mar25_0422b_raw_md|supcon_mar25_0422b_raw_md"
)
        ...
        - name: eval
          ...
          args:
            - |
              ...
              python eval_abcd.py --contrast_ckpt $BASE/modularized_nurd_hlt_con_ae/checkpoints/$CKPT --contrast_test_pt $BASE/data/hlt_smcocktail_test.pt --signal_pt $BASE/data/signal_pt/hlt_signal_TpTp.pt --outdir $BASE/abcd_outputs/$OUTDIR --raw_md_axis2 --skip_embedding_pca --wandb_run_name $WANDB_NAME
